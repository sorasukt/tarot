...
test('service worker precache is unique, complete for imports, and deletes only own caches',async()=>{
 ...
 listeners.activate({waitUntil:p=>activated=p});await activated;assert.deepEqual(deleted,['sorasukt-tarot-shell-v1','sorasukt-tarot-shell-v2-audit','sorasukt-tarot-shell-v3-delivery','sorasukt-tarot-shell-v4-home-reference']);
});
